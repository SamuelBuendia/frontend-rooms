  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-user-profile-user-profile-module"], {
    ...
    function UdT(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProfileCardComponent = /*#__PURE__*/function () {
        function ProfileCardComponent(userService) {
        ...
        _createClass(ProfileCardComponent, [{
          key: "getPic",
          value: function getPic(user) {
            if (user) {
              if (user.userprofile) {
                if (user.userprofile.avatar) {
                  return "url('".concat(user.userprofile.avatar, "')");
                }
              }
            }
    ...
    function Br0f(module, __webpack_exports__, __webpack_require__) {
      ...
      var _models_table_model__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_models_table_model__WEBPACK_IMPORTED_MODULE_0__);
      /* harmony reexport (unknown) */


      for (var __WEBPACK_IMPORT_KEY__ in _models_table_model__WEBPACK_IMPORTED_MODULE_0__) {
        if (["default", "CRUDTableModule"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function (key) {
          __webpack_require__.d(__webpack_exports__, key, function () {
            return _models_table_model__WEBPACK_IMPORTED_MODULE_0__[key];
          });
      ...
      var _models_search_model__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_models_search_model__WEBPACK_IMPORTED_MODULE_4__);
      /* harmony reexport (unknown) */


      for (var __WEBPACK_IMPORT_KEY__ in _models_search_model__WEBPACK_IMPORTED_MODULE_4__) {
        if (["default", "CRUDTableModule", "SortState", "PageSizes", "PaginatorState", "GroupingState"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function (key) {
          __webpack_require__.d(__webpack_exports__, key, function () {
            return _models_search_model__WEBPACK_IMPORTED_MODULE_4__[key];
          });
        })(__WEBPACK_IMPORT_KEY__);
      }
      /* harmony import */
      ...
      var _models_filter_model__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_models_filter_model__WEBPACK_IMPORTED_MODULE_5__);
      /* harmony reexport (unknown) */


      for (var __WEBPACK_IMPORT_KEY__ in _models_filter_model__WEBPACK_IMPORTED_MODULE_5__) {
        if (["default", "CRUDTableModule", "SortState", "PageSizes", "PaginatorState", "GroupingState"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function (key) {
          __webpack_require__.d(__webpack_exports__, key, function () {
            return _models_filter_model__WEBPACK_IMPORTED_MODULE_5__[key];
          });
        })(__WEBPACK_IMPORT_KEY__);
      }
      /* harmony import */
      ...
      var _crud_table_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./crud-table.module */
      "RbrB");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "CRUDTableModule", function () {
        return _crud_table_module__WEBPACK_IMPORTED_MODULE_7__["CRUDTableModule"];
      }); // Models
      // Directives
      // Services
      // Module
    ...
    function SBCs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! @angular/common */
      "SVse"); // tslint:disable:max-line-length component-class-suffix directive-selector directive-class-suffix component-selector no-host-metadata-property object-literal-key-quotes prefer-const
      ...
      NgPagination.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_ng_pagination_first_aria$$SRC_APP__METRONIC_SHARED_CRUD_TABLE_COMPONENTS_PAGINATOR_NG_PAGINATION_NG_PAGINATION_COMPONENT_TS__1 = goog.getMsg("First");
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_ng_pagination_previous_aria$$SRC_APP__METRONIC_SHARED_CRUD_TABLE_COMPONENTS_PAGINATOR_NG_PAGINATION_NG_PAGINATION_COMPONENT_TS__4 = goog.getMsg("Previous");
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_ng_pagination_next_aria$$SRC_APP__METRONIC_SHARED_CRUD_TABLE_COMPONENTS_PAGINATOR_NG_PAGINATION_NG_PAGINATION_COMPONENT_TS__9 = goog.getMsg("Next");
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_ng_pagination_last_aria$$SRC_APP__METRONIC_SHARED_CRUD_TABLE_COMPONENTS_PAGINATOR_NG_PAGINATION_NG_PAGINATION_COMPONENT_TS__11 = goog.getMsg("Last");
          ...
          value: function selectAllRows() {
            ...
            if (areAllSelected) {
              ...
              this.itemIds.forEach(function (id) {
                return _this5.selectedRowIds.add(id);
              });
            }
        ...
        _createClass(TableService, [{
          ...
          value: function fetch() {
            ...
            var request = this.find(this._tableState$.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (res) {
              _this13._items$.next(res.items);

              _this13.patchStateWithoutFetch({
                paginator: _this13._tableState$.value.paginator.recalculatePaginator(res.total)
              });
              ...
              _this13._isLoading$.next(false);

              var itemIds = _this13._items$.value.map(function (el) {
                var item = el;
                return item.id;
              });

              _this13.patchStateWithoutFetch({
                grouping: _this13._tableState$.value.grouping.clearRows(itemIds)
              });
            })).subscribe();
    ...
    function f48(module, __webpack_exports__, __webpack_require__) {
      ...
      ProfileOverviewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 6,
        vars: 0,
        consts: [[1, "row"], [1, "col-lg-6"], ["cssClass", "card-stretch gutter-b"]],
        ...
        _createClass(EmailSettingsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            var sb = this.userService.currentUserSubject.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])(function (user) {
              ...
              _this14.firstUserState = Object.assign({}, user);
          ...
          value: function save() {
            ...
            this.userService.isLoadingSubject.next(true);
            setTimeout(function () {
              _this15.userService.currentUserSubject.next(Object.assign({}, _this15.user));

              _this15.userService.isLoadingSubject.next(false);
            }, 2000);
          }
        }, {
          key: "cancel",
      ...
      var UserProfileComponent = /*#__PURE__*/function () {
        ...
        _createClass(UserProfileComponent, [{
          ...
          value: function ngOnInit() {
            ...
            setTimeout(function () {
              _this16.subheader.setTitle('User Profile');

              _this16.subheader.setBreadcrumbs([{
                title: 'User profile',
    ...
    function ssmD(module, __webpack_exports__, __webpack_require__) {
      ...
      var _metronic_partials_content_widgets_widgets_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      var _i18n_translation_module__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      ...
      UserProfileModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        ...
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _metronic_shared_crud_table__WEBPACK_IMPORTED_MODULE_5__["CRUDTableModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], ng_inline_svg__WEBPACK_IMPORTED_MODULE_3__["InlineSVGModule"], _user_profile_routing_module__WEBPACK_IMPORTED_MODULE_17__["UserProfileRoutingModule"], _metronic_partials_content_dropdown_menus_dropdown_menus_module__WEBPACK_IMPORTED_MODULE_7__["DropdownMenusModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbDropdownModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbTooltipModule"], _metronic_partials_content_widgets_widgets_module__WEBPACK_IMPORTED_MODULE_6__["WidgetsModule"], _i18n_translation_module__WEBPACK_IMPORTED_MODULE_19__["TranslationModule"]]]
      });
        ...
        _createClass(PersonalInformationComponent, [{
          ...
          value: function ngOnInit() {
            ...
            var sb = this.userService.currentUserSubject.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])(function (user) {
              ...
              _this18.user = Object.assign({}, user);
              _this18.firstUserState = Object.assign({}, user);
          ...
          value: function save() {
            ...
            this.userService.isLoadingSubject.next(true);
            setTimeout(function () {
              _this19.userService.currentUserSubject.next(Object.assign({}, _this19.user));

              _this19.userService.isLoadingSubject.next(false);
            }, 2000);
          }
        }, {
          key: "cancel",
          ...
          value: function getPic() {
            ...
            return "url('".concat(this.user.userprofile.avatar, "')");
          }
        }, {
          key: "deletePic",
