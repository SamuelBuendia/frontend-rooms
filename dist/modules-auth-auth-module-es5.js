(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-auth-auth-module"], {
    ...
    function l(module, __webpack_exports__, __webpack_require__) {
      ...
      var _i18n_translation_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../i18n/translation.module */
      "tM0M");
      /* harmony import */


      var _toast_services_toast_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ../toast/_services/toast.service */
      "zrJA");
      ...
      AuthModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        ...
        providers: [_toast_services_toast_service__WEBPACK_IMPORTED_MODULE_10__["ToastService"]],
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _auth_routing_module__WEBPACK_IMPORTED_MODULE_3__["AuthRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _i18n_translation_module__WEBPACK_IMPORTED_MODULE_9__["TranslationModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AuthModule, {
          declarations: [_login_login_component__WEBPACK_IMPORTED_MODULE_4__["LoginComponent"], _registration_registration_component__WEBPACK_IMPORTED_MODULE_5__["RegistrationComponent"], _forgot_password_forgot_password_component__WEBPACK_IMPORTED_MODULE_6__["ForgotPasswordComponent"], _logout_logout_component__WEBPACK_IMPORTED_MODULE_7__["LogoutComponent"], _auth_component__WEBPACK_IMPORTED_MODULE_8__["AuthComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _auth_routing_module__WEBPACK_IMPORTED_MODULE_3__["AuthRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _i18n_translation_module__WEBPACK_IMPORTED_MODULE_9__["TranslationModule"]]
        });
      })();
      /*@__PURE__*/
    ...
    function n5F(module, __webpack_exports__, __webpack_require__) {
      ...
      var _modules_i18n_translation_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../../modules/i18n/translation.service */
      "e4g8");
      /* harmony import */


      var src_app_pages_user_services__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/pages/user/_services */
      "dDNW");
      /* harmony import */
      ...
      function LoginComponent_ng_template_31_ng_container_0_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(fb, authService, route, translationService, router, userService) {
          ...
          this.router = router;
          this.userService = userService; // KeenThemes mock, change it to:
          // defaultAuth = {
          //   username: '',
          //   password: '',
          // };
        ...
        _createClass(LoginComponent, [{
          ...
          value: function initForm() {
            this.loginForm = this.fb.group({
              username: [this.defaultAuth.username, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].email, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(3), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].maxLength(320)])],
          ...
          value: function submit() {
            ...
            this.hasError = false;
            var loginSubscr = this.authService.login(this.f.username.value, this.f.password.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function (auth) {
              _this2.authService.getUserByToken().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function (userAuth) {
                if (userAuth) {
                  _this2.userService.getByIdPermissions(userAuth.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(function (user) {
                    var model = user;
                    ...
                    if (model.user.language) {
                      _this2.translationService.setLanguage(model.user.language);
                    } else {
                      _this2.translationService.setLanguage('es');
                    }

                    _this2.authService.currentUserValue = model.user;
      ...
      LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["ɵangular_packages_forms_forms_y"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatusGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroupDirective"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgIf"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControlName"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgClass"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgTemplateOutlet"]],
        pipes: [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslatePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["AsyncPipe"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
          ...
          return [{
            ...
            type: _modules_i18n_translation_service__WEBPACK_IMPORTED_MODULE_5__["TranslationService"]
          }, {
            type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]
          }, {
            type: src_app_pages_user_services__WEBPACK_IMPORTED_MODULE_6__["UserService"]
          }];
        }, null);
      })();
      /***/
    ...
    function NRzN(module, __webpack_exports__, __webpack_require__) {
      ...
      AuthComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 18,
        vars: 3,
        consts: [["id", "kt_login_wrapper", 1, "d-flex", "flex-column", "flex-root", "h-100"], ["id", "kt_login", 1, "login", "login-1", "login-signin-on", "d-flex", "flex-column", "flex-lg-row", "flex-column-fluid", "bg-white"], [1, "login-aside", "d-flex", "flex-column", "flex-row-auto", 2, "background-color", "#A6D5FA"], [1, "d-flex", "flex-column-auto", "flex-column", "py-lg-10", "pt-15"], ["href", "#", 1, "text-center", "my-5"], ["src", "./assets/media/logos/logo.png", "alt", "", 1, "max-h-70px"], [1, "font-weight-bolder", "text-center", "font-size-h4", "font-size-h1-lg", 2, "color", "#0c6bb4"], [1, "aside-img", "d-flex", "flex-row-fluid", "bgi-no-repeat", "bgi-position-y-bottom", "bgi-position-x-center", 2, "background-image", "url('./assets/media/svg/illustrations/working.svg')", "background-position", "top"], [1, "login-content", "flex-row-fluid", "d-flex", "flex-column", "justify-content-center", "position-relative", "overflow-hidden", "p-7", "mx-auto"], [1, "d-flex", "flex-column-fluid", "flex-center"], [1, "d-flex", "justify-content-lg-start", "justify-content-center", "align-items-end", "py-7", "py-lg-0"], ["href", "#", 1, "text-primary", "font-weight-bolder", "font-size-h5"]],
        template: function AuthComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, " Acad\xE9micos ");
